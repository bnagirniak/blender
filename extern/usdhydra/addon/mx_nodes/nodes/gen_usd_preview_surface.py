...
class MxNode_USD_UsdPreviewSurface(MxNode):
    ...
    nd_surfaceshader_in_diffuseColor: FloatVectorProperty(name="DiffuseColor", description="", subtype="COLOR", size=3, soft_min=0.0, soft_max=1.0, default=(0.18, 0.18, 0.18), update=MxNode.update_prop)
    nd_surfaceshader_in_emissiveColor: FloatVectorProperty(name="EmissiveColor", description="", subtype="COLOR", size=3, soft_min=0.0, soft_max=1.0, default=(0.0, 0.0, 0.0), update=MxNode.update_prop)
    ...
    nd_surfaceshader_in_specularColor: FloatVectorProperty(name="SpecularColor", description="", subtype="COLOR", size=3, soft_min=0.0, soft_max=1.0, default=(0.0, 0.0, 0.0), update=MxNode.update_prop)
    nd_surfaceshader_in_metallic: FloatProperty(name="Metallic", description="", default=0.0, update=MxNode.update_prop)
    nd_surfaceshader_in_roughness: FloatProperty(name="Roughness", description="", default=0.01, update=MxNode.update_prop)
    nd_surfaceshader_in_clearcoat: FloatProperty(name="Clearcoat", description="", default=0.0, update=MxNode.update_prop)
    nd_surfaceshader_in_clearcoatRoughness: FloatProperty(name="ClearcoatRoughness", description="", default=0.01, update=MxNode.update_prop)
    nd_surfaceshader_in_opacity: FloatProperty(name="Opacity", description="", default=1.0, update=MxNode.update_prop)
    nd_surfaceshader_in_opacityThreshold: FloatProperty(name="OpacityThreshold", description="", default=0.0, update=MxNode.update_prop)
    nd_surfaceshader_in_ior: FloatProperty(name="Ior", description="", default=1.5, update=MxNode.update_prop)
    ...
    nd_surfaceshader_in_occlusion: FloatProperty(name="Occlusion", description="", default=1.0, update=MxNode.update_prop)
