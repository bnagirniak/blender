...
class USDHYDRA_MATERIAL_PT_context(USDHydra_Panel):
    bl_label = ""
    bl_context = "material"
    ...
    def draw(self, context):
        ...
        if object:
            split.template_ID(object, "active_material",
                              new="materialx.material_duplicate_mat_mx_node_tree"
                              if hasattr(material, 'materialx') else "material.new")
            row = split.row()
...
class USDHYDRA_MATERIAL_PT_preview(USDHydra_Panel):
    bl_label = "Preview"
    bl_context = "material"
...
# class USDHYDRA_MATERIAL_OP_new_mx_node_tree(bpy.types.Operator):
#     """Create new MaterialX node tree for selected material"""
#     bl_idname = "usdhydra.material_new_mx_node_tree"
#     bl_label = "New"
#
...
# class USDHYDRA_MATERIAL_OP_duplicate_mat_mx_node_tree(bpy.types.Operator):
#     """Create duplicates of Material and MaterialX node tree for selected material"""
#     bl_idname = "usdhydra.material_duplicate_mat_mx_node_tree"
#     bl_label = ""
#
#     def execute(self, context):
...
# class USDHYDRA_MATERIAL_OP_duplicate_mx_node_tree(bpy.types.Operator):
#     """Create duplicate of MaterialX node tree for selected material"""
#     bl_idname = "usdhydra.material_duplicate_mx_node_tree"
#     bl_label = ""
#
#     def execute(self, context):
...
# class USDHYDRA_MATERIAL_OP_convert_shader_to_mx(bpy.types.Operator):
#     """Converts standard shader node tree to MaterialX node tree for selected material"""
#     bl_idname = "usdhydra.material_convert_shader_to_mx"
#     bl_label = "Convert to MaterialX"
#
#     def execute(self, context):
#         # if not context.material.usdhydra.convert_shader_to_mx(context.object):
#         #     return {'CANCELLED'}
#
#         return {"FINISHED"}


# class USDHYDRA_MATERIAL_OP_link_mx_node_tree(bpy.types.Operator):
#     """Link MaterialX node tree to selected material"""
#     bl_idname = "usdhydra.material_link_mx_node_tree"
#     bl_label = ""
#
...
#             if ng.bl_idname != 'usdhydra.MxNodeTree':
#                 continue
#
#             row = layout.row()
#             row.enabled = bool(ng.output_node)
#             op = row.operator(USDHYDRA_MATERIAL_OP_link_mx_node_tree.bl_idname,
#                               text=ng.name, icon='MATERIAL')
#             op.mx_node_tree_name = ng.name


# class USDHYDRA_MATERIAL_PT_material(USDHydra_Panel):
#     bl_label = ""
#     bl_context = "material"
#
#     @classmethod
...
#
#     def draw(self, context):
#         mat_usdhydra = context.material.usdhydra
#         layout = self.layout
#
...
#         row.menu(USDHYDRA_MATERIAL_MT_mx_node_tree.bl_idname, text="", icon='MATERIAL')
#
#         if mat_usdhydra.mx_node_tree:
#             row.prop(mat_usdhydra.mx_node_tree, 'name', text="")
#             row.operator(USDHYDRA_MATERIAL_OP_convert_shader_to_mx.bl_idname, icon='FILE_TICK', text="")
#             row.operator(USDHYDRA_MATERIAL_OP_duplicate_mx_node_tree.bl_idname, icon='DUPLICATE')
#             row.operator(USDHYDRA_MATERIAL_OP_unlink_mx_node_tree.bl_idname, icon='X')
#
#         else:
#             row.operator(USDHYDRA_MATERIAL_OP_convert_shader_to_mx.bl_idname, icon='FILE_TICK', text="Convert")
#             row.operator(USDHYDRA_MATERIAL_OP_new_mx_node_tree.bl_idname, icon='ADD', text="")
...
# class USDHYDRA_MATERIAL_OP_link_mx_node(bpy.types.Operator):
#     """Link MaterialX node"""
#     bl_idname = "usdhydra.material_link_mx_node"
#     bl_label = ""
#
...
# class USDHYDRA_MATERIAL_OP_invoke_popup_input_nodes(bpy.types.Operator):
#     """Open panel with nodes to link"""
#     bl_idname = "usdhydra.material_invoke_popup_input_nodes"
#     bl_label = ""
#
#     input_num: bpy.props.IntProperty()
#     current_node_name: bpy.props.StringProperty()
...
#         layout = self.layout
        ...
        #     row = col.row()
        #     row.alignment = 'LEFT'
        #     op = row.operator(USDHYDRA_MATERIAL_OP_link_mx_node.bl_idname, text=cls.bl_label)
        #     op.new_node_name = cls.bl_idname
        #     op.input_num = self.input_num
        #     op.current_node_name = self.current_node_name
        #     i += 1
        #
        # input = context.material.usdhydra.mx_node_tree.nodes[self.current_node_name].inputs[self.input_num]
        # if input.is_linked:
        #     link = input.links[0]
        #
        #     col = split.column()
        ...
        #     row = col.row()
        #     row.alignment = 'LEFT'
        #     op = row.operator(USDHYDRA_MATERIAL_OP_remove_node.bl_idname)
        #     op.input_node_name = link.from_node.name
        #
        #     row = col.row()
        #     row.alignment = 'LEFT'
        #     op = row.operator(USDHYDRA_MATERIAL_OP_disconnect_node.bl_idname)
        #     op.output_node_name = link.to_node.name
        #     op.input_num = self.input_num


# class USDHYDRA_MATERIAL_OP_invoke_popup_shader_nodes(bpy.types.Operator):
#     """Open panel with shader nodes to link"""
#     bl_idname = "usdhydra.material_invoke_popup_shader_nodes"
#     bl_label = ""
#
#     input_num: bpy.props.IntProperty()
#     new_node_name: bpy.props.StringProperty()
...
#         layout = self.layout
        ...
        #
        # output_node = context.material.usdhydra.mx_node_tree.output_node
        # for cls in mx_node_classes:
        #     if cls.category != "PBR":
        #         continue
        #
...
# class USDHYDRA_MATERIAL_OP_remove_node(bpy.types.Operator):
#     """Remove linked node"""
#     bl_idname = "usdhydra.material_remove_node"
#     bl_label = "Remove"
#
...
#     #
#     #     context.material.usdhydra.mx_node_tree.nodes.remove(node)
#
#     def execute(self, context):
#         # node_tree = context.material.usdhydra.mx_node_tree
...
# class USDHYDRA_MATERIAL_OP_disconnect_node(bpy.types.Operator):
#     """Disconnect linked node"""
#     bl_idname = "usdhydra.material_disconnect_node"
#     bl_label = "Disconnect"
#
...
# class USDHYDRA_MATERIAL_PT_material_settings_surface(USDHydra_ChildPanel):
#     bl_label = "surfaceshader"
#     bl_parent_id = 'USDHYDRA_MATERIAL_PT_material'
#
#     @classmethod
#     def poll(cls, context):
#         return bool(context.material.usdhydra.mx_node_tree)
    ...
    def draw(self, context):
        ...
        # box.scale_x = 0.7
        # box.scale_y = 0.5
        # op = box.operator(USDHYDRA_MATERIAL_OP_invoke_popup_shader_nodes.bl_idname, icon='HANDLETYPE_AUTO_CLAMP_VEC')
...
# class USDHYDRA_MATERIAL_PT_material_settings_displacement(USDHydra_ChildPanel):
...
# class USDHYDRA_MATERIAL_PT_output_node(USDHydra_ChildPanel):
#     bl_label = ""
#     bl_parent_id = 'USDHYDRA_MATERIAL_PT_material'
#
#     @classmethod
#     def poll(cls, context):
#         return not bool(context.material.usdhydra.mx_node_tree)
#
#     def draw(self, context):
#         layout = self.layout
#
...
#         #
#         # output_node = context.material.usdhydra.output_node
#         # if not output_node:
#         #     layout.label(text="No output node")
#         #     return
#         #
...
# class USDHYDRA_MATERIAL_PT_output_surface(USDHYDRA_MATERIAL_PT_output_node):
#     bl_label = "Surface"
#
#
# class USDHYDRA_MATERIAL_PT_output_displacement(USDHYDRA_MATERIAL_PT_output_node):
#     bl_label = "Displacement"
#     bl_options = {'DEFAULT_CLOSED'}
#
#
# class USDHYDRA_MATERIAL_PT_output_volume(USDHYDRA_MATERIAL_PT_output_node):
#     bl_label = "Volume"
#     bl_options = {'DEFAULT_CLOSED'}


# class USDHYDRA_MATERIAL_OP_export_mx_file(USDHydra_Operator, ExportHelper):
#     bl_idname = "usdhydra.material_export_mx_file"
...
#         name="Clean texture folder",
#         description="Clean texture folder before export",
#         default=False
#     )
#     is_clean_deps_folders: bpy.props.BoolProperty(
#         name="Clean dependencies folders",
#         description="Clean MaterialX dependencies folders before export",
#         default=False
#     )
...
#
#     def execute(self, context):
#         # usdhydra_prop = context.material.usdhydra
#         #
#         # if not usdhydra_prop.convert_shader_to_mx():
#         #     return {'CANCELLED'}
#         #
#         # doc = context.material.usdhydra.export(None)
#         # if not doc:
#         #     return {'CANCELLED'}
#         #
...
#         #                            mx_node_tree=usdhydra_prop.mx_node_tree,
...
#         #
#         # bpy.data.node_groups.remove(usdhydra_prop.mx_node_tree)
#         return {'FINISHED'}
#
#     def draw(self, context):
...
# class USDHYDRA_MATERIAL_OP_export_mx_console(USDHydra_Operator):
#     bl_idname = "usdhydra.material_export_mx_console"
#     bl_label = "Export MaterialX to Console"
#     bl_description = "Export material as MaterialX node tree to console"
#
#     def execute(self, context):
#         # doc = context.material.usdhydra.export(context.object)
#         # if not doc:
#         #     return {'CANCELLED'}
#         #
...
# class USDHYDRA_MATERIAL_PT_tools(USDHydra_Panel):
...
#         layout = self.layout
#
#         layout.operator(USDHYDRA_MATERIAL_OP_convert_shader_to_mx.bl_idname, icon='FILE_TICK')
#         layout.operator(USDHYDRA_MATERIAL_OP_export_mx_file.bl_idname, text="Export MaterialX to file", icon='EXPORT')


# class USDHYDRA_MATERIAL_PT_dev(USDHydra_ChildPanel):
#     bl_label = "Dev"
#     bl_parent_id = 'USDHYDRA_MATERIAL_PT_tools'
#     bl_space_type = "NODE_EDITOR"
#     bl_region_type = "UI"
#     bl_category = "Tool"
#
...
#         layout = self.layout
#
#         layout.operator(USDHYDRA_MATERIAL_OP_export_mx_console.bl_idname)
...
#         mx_node_tree = context.object.active_material.usdhydra.mx_node_tree
#
...
#             if not mx_node_tree:
#                 if area.ui_type != 'usdhydra.MxNodeTree':
#                     continue
#
#                 area.ui_type = 'ShaderNodeTree'
#                 continue
#
#             if area.ui_type not in ('usdhydra.MxNodeTree', 'ShaderNodeTree'):
#                 continue
#
...
#                 continue
#
#             area.ui_type = 'usdhydra.MxNodeTree'
...
#
#     space = context.space_data
#     if space.tree_type != 'usdhydra.MxNodeTree':
#         return
#
#     ui_mx_node_tree = mat.usdhydra.mx_node_tree
#     editor_node_tree = space.node_tree
#
#     if editor_node_tree != ui_mx_node_tree and not space.pin and editor_node_tree:
#         mat.usdhydra.mx_node_tree = editor_node_tree
